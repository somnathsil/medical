...
export class PatientAddComponent implements OnInit {
	...
	private initPatientAddForm() {
		this.addPatientStepOneForm = this._formBuilder.group({
	...
	get formcontrol() {
		return this.addPatientStepOneForm.controls;
	}
	...
	public hasFormControlError(field: string): boolean {
		const control = this.addPatientStepOneForm.get(field) as FormControl;
		if (
	...
	onStepOneFormSubmit(): boolean | void {
		this.submitted = true;
		const formValue = this.addPatientStepOneForm.value;

		// stop here if form is invalid
		if (this.addPatientStepOneForm.invalid) {
			return false;
		}

		//form is valid
		if (this.addPatientStepOneForm.valid) {
