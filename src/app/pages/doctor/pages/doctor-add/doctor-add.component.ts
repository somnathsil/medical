...
export class DoctorAddComponent implements OnInit {
	...
	public addDoctorStepOneForm!: FormGroup;
	...
	private initPatientAddForm() {
		this.addDoctorStepOneForm = this._formBuilder.group({
	...
	get formcontrol() {
		return this.addDoctorStepOneForm.controls;
	}
	...
	public hasFormControlError(field: string): boolean {
		const control = this.addDoctorStepOneForm.get(field) as FormControl;
		if (
	...
	onStepOneFormSubmit(): boolean | void {
		this.submitted = true;
		const formValue = this.addDoctorStepOneForm.value;

		// stop here if form is invalid
		if (this.addDoctorStepOneForm.invalid) {
			return false;
		}

		//form is valid
		if (this.addDoctorStepOneForm.valid) {
